!(function (modules) {
        ...
        return (
          ...
          (SheetBlock.prototype.setPoints = function (left, right, offset) {
            ...
            if (
              ...
              for (
                var _i8 = 0, l = this.geometry.vertices.length;
                _i8 < l;
                ++_i8
              )
                if (
          ...
          (SheetBlock.prototype.interpolate = function (x, y, xi) {
            ...
            for (
              var spline = this.aSplines[x.length], _i11 = 0;
              _i11 < x.length;
              ++_i11
            )
      ...
      Pdf = (function () {
        function Pdf(src, loadingProgress, openOptions) {
          ...
          _classCallCheck(this, Pdf),
            ...
            (this.pdfJsWorker =
              PATHS.pdfJsLib && Pdf.isStable()
                ? PATHS.stablePdfJsWorker
                : PATHS.pdfJsWorker),
            (PDFJS
        ...
        return (
          (Pdf.isStable = function () {
            return (
              !(window.Promise || {}).withResolvers && PATHS.stablePdfJsLib
            );
          }),
                  ...
                  ? (done = (
                      ...
                      return (
                        (_this2.doubledLastPage =
                          p0s.width / p0s.height / (pls.width / pls.height) <
                          0.75),
                        handler
                      );
                    }))
          ...
          (Pdf.prototype.getPageType = function (n) {
            return !this.doubledPages ||
              0 === n ||
              (n === this.getPagesNum() - 1 && !this.doubledLastPage)
              ? "full"
              : 1 & n
              ? "left"
              : "right";
          ...
          (Pdf.prototype.getPagesNum = function () {
            return this.handler
              ? this.doubledPages
                ? 1 +
                  2 * (this.handler.numPages - (1 + !this.doubledLastPage)) +
                  !this.doubledLastPage
  ...
  function (module, exports, __webpack_require__) {
    ...
    ($.fn.FlipBook = function (options) {
      ...
      $(function () {
        for (
          var containers = $(".flip-book-container"), i = 0;
          i < containers.length;
          ++i
        ) {
      ...
      Book = (function (_THREE$EventDispatche) {
          ...
          return (
            (_this.cssFs = {
              play: function (player) {
                if (player.play)
                  (player.fb3dNoPlay = !1),
                    (player.play() || { catch: function () {} }).catch(
                      function (e) {
                        player.fb3dNoPlay ||
        ...
        return (
          ...
          (Book.prototype.init = function (
            ...
            (this.args = {
              ...
              (this.p = _extends(
                ...
                this.prepareProps(
                  _extends({}, props, {
                    sheets: this.isHalfBookMode()
                      ? Math.max(props.pages - 2, 0)
                      : sheets,
                  })
                ),
                {
            ...
            if (
              ...
              2 === this.getPages() &&
                (this.enableMouse(!1),
                (coverP[this.p.rtl ? "left" : "right"] = _extends(
                  {},
                  this.p.cover,
            ...
            this.set(Math.PI / 2),
              (this.openedBox = new _libs.THREE.Box3().setFromObject(
                this.leftCover.three
              )),
              this.openedBox.union(
                new _libs.THREE.Box3().setFromObject(this.rightCover.three)
              ),
              ...
              (this.binds = {
                ...
                pageManagerRefreshZoom: this.pageManager.refreshZoom.bind(
                  this.pageManager
                ),
              }),
              this.visual.addRenderCallback(this.binds.update),
              (0, _libs.$)(this.visual.element).on(
                "mousemove",
              ...
              (this.binds.onReleaseCallback =
                this.onReleaseCallback.bind(this)),
              (this.visual.drag.onReleaseCallback =
                this.binds.onReleaseCallback),
              (this.dragAngle = 0.05),
              (this.tmp = {
              ...
              this.visual.addEventListener(
                "resize",
                this.binds.pageManagerRefreshZoom
              ),
              setTimeout(function () {
                _this2.isProcessing() ||
          ...
          (Book.prototype.calculateShadow = function () {
            ...
            this.isHalfBookMode()
              ? box.setFromObject(
                  (this.p.rtl ? this.leftCover : this.rightCover).three
                )
          ...
          (Book.prototype.dispose = function () {
            this.visual.removeObject(this.three),
              ...
              this.visual.removeEventListener(
                "resize",
                this.binds.pageManagerRefreshZoom
              ),
              ...
              res
                .then(function () {
                  return (
                    ...
                    1 === _this8.sheetPhysics.getSize() &&
                      _this8.reducePagesWidth(!1),
                    block
                  );
                })
                .catch(function () {})
            ...
            if (block && leftSize < block.getSize()) {
              ...
              if (this.isHalfBookMode()) {
                ...
                for (var _i10 = 0; _i10 < newBlock.materials.length; ++_i10)
                  (newBlock.materials[_i10].opacity =
                    block.materials[_i10].opacity),
                    (newBlock.materials[_i10].transparent =
                      block.materials[_i10].transparent);
              ...
              return n >= 0 && nn < _this10.getPages()
                ? loader(nn, function (ls) {
                    for (
                      ...
                      var l = _ref10;
                      nls.push(
                        _extends({}, l, { js: _this10.cssLayerJsObject(l) })
                      );
                    }
                    return clb(nls);
                  })
            ...
            return {
              hide: function () {
                _this12.pendingPlayers.length &&
                  ...
                  _this12.dispatchEvent({ type: "pendingPlayers" })),
    ...
    var _typeof =
      ...
      BookController = (function (_Controller) {
          ...
          (_this.navigationControls = !0),
            ...
            (_this.state = {
              ...
              singlePage:
                !(
                  !_this.isSinglePageAvailable() ||
                  "full" !== _this.book.p.singlePageMode
                ) &&
                (_this.actions.cmdSinglePage.active ||
                  (_this.actions.cmdSinglePage.activeForMobile &&
                    _this.visual.isMobile())),
        ...
        return (
          ...
          (BookController.prototype.setEmbeddedInline = function (
            embeddedInline
          ) {
          ...
          (BookController.prototype.isSinglePageAvailable = function () {
            return (
              2 !== this.book.getRealPages() ||
              "half" === this.book.p.singlePageMode
            );
          }),
          ...
          (BookController.prototype.updateViewState = function () {
            this.viewState = {
              ...
              cmdSearchBtn: {
                enable: !!this.tocCtrl,
                visible:
                  this.isCmdVisible("cmdSearchBtn") &&
                  this.tocCtrl &&
                  this.tocCtrl.search,
                active:
                  this.tocCtrl &&
          ...
          (PageManager.prototype.imageToPageTexture = function (o, n, image) {
            if (
              ...
              (co.c.width = o.match.pageWidth),
                ...
                co.ctx.save(),
                co.ctx.beginPath(),
                (co.ctx.fillStyle = _GraphUtils2.default.color2Rgba(
                  o.color,
                  1
                )),
                    ...
                    (o.wrapper.onChange = function (image, canceled) {
                      canceled
                        ...
                        : o.texture &&
                          ...
                          (o.texture.image = _this3.imageToPageTexture(
                            o,
                            n,
                            image
                          )),
          ...
          (PageManager.prototype.calcResolution = function (o) {
            ...
            if (this.p.autoResolution.enabled) {
              var k =
                ...
                Math.min(
                  ((this.isSinglePage(o) || this.book.isHalfBookMode()
                    ? 1
                    : 0.5) *
                    this.visual.width()) /
                    o.widthTexels,
      ...
      TocController = (function (_WidgetController) {
        ...
        return (
          ...
          (TocController.prototype.openUrl = function (url) {
            -1 === url.toLowerCase().search("javascript:") &&
            ...
            if (this.finder) {
              for (
                ...
                var hit = _ref4,
                  ...
                  t = _BaseMathUtils2.default.pdfJsTransform(
          ...
          (Search.prototype.setResults = function (results, lastPage) {
            ...
            (0, _libs.$)(htmls.join("")).appendTo(this.results),
              ...
              void 0 === lastPage
                ? this.status.html("")
                : this.status.html(
                    lastPage + 1 + " " + (0, _libs.tr)("of") + " " + this.pages
                  );
          }),
          Search
        );
